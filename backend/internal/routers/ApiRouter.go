...
func playerSetRouter(api *gin.RouterGroup) {
	playersetssr := api.Group("/playerset")
	{
		...
		playersetssr.POST("/elimination/:eliminationid/auto", endpoint.AutoCreateIndividualPlayerSets)
		playersetssr.GET("/elimination/:eliminationid/ranking", endpoint.GetPlayerSetRanking)
		playersetssr.PATCH("/elimination/:eliminationid/ranking", endpoint.UpdatePlayerSetRankingByEliminationId)
		playersetssr.PATCH("/elimination/:eliminationid/ranking/auto", endpoint.AutoRankPlayerSetsByEliminationId)
