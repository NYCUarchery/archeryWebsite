...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "headers": {
                            "X-Total-Count": {
                                "type": "string",
                                "description": "Total number of competitions for the user"
                            }
                        }
                    },
                    "400": {
        ...
        "/competition/{id}/qualification-assignments": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "CSV assignment data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/endpoint.QualificationAssignmentRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/endpoint.QualificationAssignmentImportResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/endpoint.QualificationAssignmentErrorResponse"
                        }
                    },
                    "403": {
        ...
        "/competition/{id}/qualification-assignments/preview": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/endpoint.QualificationAssignmentPreviewResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/user/bulk": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "CSV, prefix, and competition",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/endpoint.BulkRegisterRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/endpoint.BulkRegisterResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/endpoint.BulkRegisterErrorResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/endpoint.BulkRegisterPreviewResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "endpoint.BulkRegisterCreatedRow": {
            "type": "object",
            "properties": {
                "line": {
                    "type": "integer"
        ...
        "endpoint.BulkRegisterErrorResponse": {
            "type": "object",
            "properties": {
                "errors": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/endpoint.BulkRegisterIssue"
                    }
                }
            }
        },
        "endpoint.BulkRegisterIssue": {
            "type": "object",
            "properties": {
                "field": {
                    "type": "string"
        ...
        "endpoint.BulkRegisterPreviewResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
                ...
                "rows": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/endpoint.BulkRegisterPreviewRow"
                    }
                }
            }
        },
        "endpoint.BulkRegisterPreviewRow": {
            "type": "object",
            "properties": {
                "line": {
                    "type": "integer"
        ...
        "endpoint.BulkRegisterResponse": {
            ...
            "properties": {
                ...
                "rows": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/endpoint.BulkRegisterCreatedRow"
                    }
                }
            }
        },
        ...
        "endpoint.QualificationAssignmentErrorResponse": {
            "type": "object",
            "properties": {
                "errors": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/endpoint.QualificationAssignmentIssue"
                    }
                }
            }
        },
        "endpoint.QualificationAssignmentImportResponse": {
            "type": "object",
            "properties": {
                "assigned_count": {
                    "type": "integer"
        ...
        "endpoint.QualificationAssignmentIssue": {
            "type": "object",
            "properties": {
                "field": {
                    "type": "string"
        ...
        "endpoint.QualificationAssignmentPreviewResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
                ...
                "rows": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/endpoint.QualificationAssignmentPreviewRow"
                    }
                }
            }
        },
        "endpoint.QualificationAssignmentPreviewRow": {
            "type": "object",
            "properties": {
                "group_id": {
                    "type": "integer"
        ...
        "endpoint.QualificationAssignmentRequest": {
            "type": "object",
            "properties": {
                "csv": {
                    "type": "string"
