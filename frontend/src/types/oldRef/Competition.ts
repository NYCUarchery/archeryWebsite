...
export interface SimpleCompetition {
  competition_id: number;
  group_datas: SimpleCompetitionGroupData[];
}

export interface SimpleCompetitionGroupData {
  group_id: number;
  group_name: string;
  group_range: string;
  bow_type: string;
  elimination_datas: SimpleCompetitionEliminationData[];
}

export interface SimpleCompetitionEliminationData {
